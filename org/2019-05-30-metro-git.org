...
Then I remembered reading about the project [[https://github.com/vbarbaresi/MetroGit][MetroGit]],
...
[[https://pt.saopaulomap360.com/mapa-metro-sao-paulo][São Paulo]] metro system would generate the following shell commands:
...
A git graph is a [[https://eagain.net/articles/git-for-computer-scientists/][Directed *Acyclic* Graph]],
which means that we need to build a graph with directions from stations and connections and remove the *minimum* number of cycles in case it's needed.
...
For Clojure(script), there is an awesome library called [[https://github.com/aysylu/loom][loom]],
...
It does a [[https://en.wikipedia.org/wiki/Topological_sorting][Topological Sorting]] to confirm if the graph is a DAG or not.
It takes ~O(E+V)~,
...
The [[https://clojure.org/reference/atoms][atom]] construct was used to update a value in two different places of the same function,
...
I'm grateful for the creators of [[https://github.com/vbarbaresi/MetroGit][MetroGit]] (Paris) from where I got the original idea
and [[https://github.com/bburky/git-dc-metro][git-dc-metro]] (Washington) for providing me the correct format of the commands =P

If you're interested, the code for the project [[https://github.com/gjhenrique/metro-clojure][metro-clojure]] is in github.
