...
# and, mainly, because every _major or famous_ programming languages have some way to interact with it.
# The architecture will be inspired in  movie and will have these components:
...
Let me show a brief demo that you have a C file that calculates the power of a number
#+BEGIN_SRC C
int pow(int n) {
  return n * n;
}
...
If you want to learn more about this architecture, check other demo games in the [[https://github.com/gjhenrique/modulartetris][github repository]].

Thanks for your time and leave a comment if you have any suggestions.
# To learn more about the library, try to implement a tetris game using the language you want.
