...
By the way, these colors are from the [[https://github.com/doomemacs/themes/blob/master/themes/doom-one-theme.elhttps://github.com/belak/base16-emacs][doom-one theme]],
